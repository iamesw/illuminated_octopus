...
<div class="container">
	<div class="row">
		<div class="col">
			{% set navPages = collections.all | eleventyNavigationBreadcrumb("aotr-marketing") %}
	...
	<div class="row">
		<div class="col">
			...
			<figcaption>Posters | Branding</br>Fonts in Use:</br>2010–2022: Akzidenz Grotesk / 2023: Oswald and Public Sans</figcaption>
			<hr>
